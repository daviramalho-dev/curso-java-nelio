...
public class Program {
    public static void main(String[] args) {
         ...
         * número da conta o nome do titular da conta, e o valor de depósito inicial que
         * o titular depositou ao abrir a conta. Este valor de depósito inicial,
         ...
         * conta, dando opção para ser ou não informado o valor de depósito
        ...
        char response = daviScanner.next().charAt(0);

        if (response == 'Y') {
            System.out.println("Enter initial deposit value: ");
            double initialDeposit = daviScanner.nextDouble();
        ...
        System.out.println("\nEnter deposit value: ");
        double depositValue = daviScanner.nextDouble();
        ...
        double withdrawvalue = daviScanner.nextDouble();
